...
<head>
    ...
    <title>Registrasi Aplikasi Document Generator</title>
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        ...
        @if($errors->any())
            <div class="alert alert-danger alert-dismissible fade show mb-3" role="alert">
                <div><i class="fas fa-exclamation-triangle me-2"></i><strong>Validasi Gagal!</strong></div>
                <ul class="mb-0 mt-2">
        ...
        <form method="POST" action="{{ route('register.post') }}">
          ...
          <div class="divider d-flex align-items-center my-4">
            <p class="text-center fw-bold mx-3 mb-0">Daftar Pengguna Baru</p>
          </div>
          ...
          <div class="d-flex justify-content-between align-items-center">
            <div class="form-check mb-0 @error('accept_terms') is-invalid @enderror">
              <input class="form-check-input me-2 @error('accept_terms') is-invalid @enderror" type="checkbox" name="accept_terms" value="1" id="form2Example3" />
              <label class="form-check-label" for="form2Example3">
                saya telah membaca dan menyetujui perjanjian pengguna serta kebijakan privasi
              </label>
              @error('accept_terms')
                <div class="text-danger small mt-2" style="display: block;">
        ...
        <div class="d-flex justify-content-between align-items-center mt-3 pt-1 mb-0">
             <p class="small fw-bold mb-0">Sudah punya akun? <a href="{{ url('/login') }}" class="link-primary">Login</a></p>
        </div>
