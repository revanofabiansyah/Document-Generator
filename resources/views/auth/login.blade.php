...
<head>
    ...
    <title>Login Aplikasi Document Generator Sederhana</title>
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      {{-- Notif sukses / error --}}
        ...
        <div class="d-flex justify-content-between align-items-center mt-3 pt-1 mb-0">
             <p class="small fw-bold mb-0">Belum punya akun? <a href="{{ url('/register') }}" class="link-primary">Daftar</a></p>
             <p class="small fw-bold mb-0">Anda Admin? <a href="{{ url('/login-admin') }}" class="link-danger">Klik Disini</a></p>
        </div>
